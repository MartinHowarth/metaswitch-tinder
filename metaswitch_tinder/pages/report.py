...
def layout():
    return html.Div(
        [
            ...
            html.A("Raise it on github!", href="https://github.com/MartinHowarth/metaswitch-tinder/issues",
                   className="lead"),
            html.Br(),
            html.Br(),
            html.Br(),
            html.H4("Want to report inappropriate content, or abuse, for review? Send us an email:"),
            dcc.Textarea(
